...
class ModelProviderErrorHandler:
    ...
    def handle_api_error(error: Exception, agent_id: str = "unknown") -> dict[str, Any]:
        ...
        # Check for quota/rate limit issues
            ...
            logger.warning(
                f"⏱️ Rate limit hit for agent {agent_id}",
        ...
        # Check for model availability issues
            ...
            logger.error(
                f"🤖 Model not available for agent {agent_id}",
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def async_wrapper(*args, **kwargs):
            try:
                ...
                if any(error_type in str(type(e)) for error_type in [
                    "ModelProviderError", "ClientError", "ServerError",
                    "APIError", "AuthenticationError", "PermissionError",
                    "google.genai.errors", "GoogleAIError", "GenerativeAIError"
                ]):
